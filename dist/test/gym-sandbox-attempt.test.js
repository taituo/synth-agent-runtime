...
import { EXECUTOR_IMAGE, GymFixtureUnavailableError, loadGymTask, materializeGymTask, runGymAttempt, } from "../src/index.js";
...
test("a sandbox attempt runs the tools in the pod and scores the golden fix passed", async (t) => {
    if (!liveEnabled()) {
