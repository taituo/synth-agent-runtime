...
import { CompositeTenantPolicy, InMemoryRouterStateStore, InMemorySharedRateLimitStore, InMemoryTenantRateLimitPolicy, ModelAclPolicy, ProfileRouterBackend, SharedTenantRateLimitPolicy, StaticBearerAuthenticator, createInferenceGateway, } from "../src/index.js";
...
test("static bearer authenticator compares tokens safely across lengths", () => {
    ...
    const request = (token) => new Request("http://gateway/v1/models", { headers: { authorization: `Bearer ${token}` } });
