...
import { DEFAULT_KUBERNETES_RESOURCE_CLASSES, EXECUTOR_IMAGE, EXECUTOR_IMAGE_DOCKERFILE, } from "../src/index.js";
...
test("the pinned image is built from deploy/executor-image with a non-root user", () => {
    const dockerfile = readFileSync(fileURLToPath(new URL(`../../${EXECUTOR_IMAGE_DOCKERFILE}`, import.meta.url)), "utf8");
