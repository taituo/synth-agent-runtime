 ...
 * boundary change under a run. The Dockerfile carries node and git because the
 * gym's `run_visible_test` and the git transport both execute inside the pod.
 *
 ...
 */
export declare const EXECUTOR_IMAGE = "ghcr.io/taituo/synth-executor@sha256:fc59cec2b7a3733e9e50db1d5063669c60ec7add0d18a338b2a3f19a422c822f";
/** The Dockerfile this image is built from, repo-relative. */
export declare const EXECUTOR_IMAGE_DOCKERFILE = "deploy/executor-image/Dockerfile";
