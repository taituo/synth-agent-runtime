import { AgentRuntime, InMemoryWorldStore, LocalMemoryDurability, MemoryWorkspace, Supervisor, } from "../src/index.js";
...
const supervisorEngine = { async run() { return { ok: true }; } };
