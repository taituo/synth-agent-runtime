...
export const sendMessage = defineSignal("sendMessage");
export const cancelAgent = defineSignal("cancelAgent");
export const getAgentState = defineQuery("getAgentState");
 ...
 */
export async function durableAgentWorkflow(initial) {
