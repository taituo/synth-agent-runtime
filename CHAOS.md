...
## v0.8 distributed chaos targets

Add delayed stale writers past lease expiry, concurrent project CAS writers, duplicate mailbox delivery, abandoned-command reconciliation, and shared-router replica failover to the failure matrix. The packaged unit/contract suite covers the deterministic forms; real multi-host clock-skew and infrastructure tests remain external.
