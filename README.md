...
```text
npm test  (root suite)
297 tests: 294 passed / 0 failed / 3 skipped
(the 3 skips are the live gVisor proofs — the boundary test and the per-pod
NetworkPolicy cleanup test; set SYNTH_LIVE_GVISOR=1)
