 ...
 */
export async function createScopedPushGrant(options: CreateScopedPushGrantOptions): Promise<ScopedPushGrant> {
...
export async function scopedPush(options: { workDir: string; remote: string; localRef: string; ref: string }): Promise<ScopedPushResult> {
  try {
