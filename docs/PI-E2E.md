...
The artifact environment used to build v0.7 does not contain a Pi checkout, so these external tests are syntax-checked but are not reported as executed here.
